...
namespace StyleUs.ViewModel.Component
{
    public class SmallPostViewModel : BindableBase, INotifyPropertyChanged
    {
        ...
        public ICommand notification { get; set; }
		public ICommand clothPiece { get; set; }
		public ICommand clothCombination { get; set; }

        public INavigationService navigation;

        public SmallPostViewModel(INavigationService navigationService)
        {
              ...
              notification = new Command(goToNotification);
